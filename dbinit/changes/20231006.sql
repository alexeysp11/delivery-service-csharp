alter table delivery_category add column picture_url text;
alter table delivery_category_c add column picture_url text;
alter table delivery_category add column picture_description varchar(50);
alter table delivery_category_c add column picture_description varchar(50);

update delivery_category_c 
set 
