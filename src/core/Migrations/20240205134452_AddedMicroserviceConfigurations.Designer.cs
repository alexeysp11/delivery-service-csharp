...
namespace DeliveryService.Core.Migrations
{
    ...
    [Migration("20240205134452_AddedMicroserviceConfigurations")]
    partial class AddedMicroserviceConfigurations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cims.WorkflowLib.Models.Network.MicroserviceConfigurations.Endpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Cims.WorkflowLib.Models.Network.MicroserviceConfigurations.MicroserviceCommunicationConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("EndpointFromId")
                        .HasColumnType("integer");

                    b.Property<int?>("EndpointToId")
                        .HasColumnType("integer");

                    b.Property<int?>("NetworkInteractionDetailsId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("NetworkInteractionDetailsId");

                    b.ToTable("MicroserviceCommunicationConfigurations");
                });

            modelBuilder.Entity("Cims.WorkflowLib.Models.Network.MicroserviceConfigurations.NetworkInteractionDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("NetworkInteractionDetails");
                });
            ...
            modelBuilder.Entity("Cims.WorkflowLib.Models.Network.MicroserviceConfigurations.MicroserviceCommunicationConfiguration", b =>
                {
                    b.HasOne("Cims.WorkflowLib.Models.Network.MicroserviceConfigurations.Endpoint", "EndpointFrom")
                        .WithMany()
                        .HasForeignKey("EndpointFromId");

                    b.HasOne("Cims.WorkflowLib.Models.Network.MicroserviceConfigurations.Endpoint", "EndpointTo")
                        .WithMany()
                        .HasForeignKey("EndpointToId");

                    b.HasOne("Cims.WorkflowLib.Models.Network.MicroserviceConfigurations.NetworkInteractionDetails", "NetworkInteractionDetails")
                        .WithMany()
                        .HasForeignKey("NetworkInteractionDetailsId");

                    b.Navigation("EndpointFrom");

                    b.Navigation("EndpointTo");

                    b.Navigation("NetworkInteractionDetails");
                });
